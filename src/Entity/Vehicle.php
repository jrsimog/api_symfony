 ...
 * Vehicle
 *
 * @ORM\Table(name="vehicle", indexes={@ORM\Index(name="fk_state_idx", columns={"state_fk"}), @ORM\Index(name="fk_origin_idx", columns={"origin_fk"}), @ORM\Index(name="fk_branch_office_idx", columns={"branch_office_fk"}), @ORM\Index(name="fk_priority_idx", columns={"priority_fk"}), @ORM\Index(name="vehicle_type_fk_idx", columns={"vehicle_type_fk"}), @ORM\Index(name="fk_automotive_idx", columns={"automotive_fk"})})
 * @ORM\Entity
 */
class Vehicle
{
